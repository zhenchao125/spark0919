package com.atuigu.mock

import java.util.Properties

import com.atuigu.mock.bean.CityInfo
import com.atuigu.mock.util.{RandomNumUtil, RandomOptions}
    ...
    def mockRealTimeData(): ArrayBuffer[String] = {
        ...
        (1 to 50).foreach {
            i => {
                ...
                val adsid = RandomNumUtil.randomInt(1, 5)
                array += s"$timestamp,$area,$city,$userid,$adsid"
                Thread.sleep(10)
            }
        }
        array
